...
### 🎙️ आवाज-निवड — काय काय try केलं (repo मधल्या `audio-drafts/` फोल्डरवरून पडताळलं)

**१. तीन उमेदवार आवाज तुलना केले** — Sarvam Bulbul v3 च्या मराठी आवाजांपैकी **priya, ritu, shreya** — प्रत्येकाचा एक नमुना-परिच्छेद टेस्ट-रेकॉर्ड केला (`sample-museum-priya`, `sample-museum-ritu`, `sample-museum-shreya`), प्रत्येकाची **v2 आवृत्ती** (सुधारित पॅरामीटर्स) सुद्धा. अंतिम निवड: **ritu.**

**२. ritu साठी ३ tonal आवृत्त्या टेस्ट केल्या** — `sample-ritu-intimate` (जवळीकीचा सूर), `sample-ritu-lively` (उत्साही), `sample-ritu-warm` (उबदार) — यातून शेवटी वापरलेले pace/temperature पॅरामीटर ठरले (Section 6 च्या मुख्य टेबलमध्ये नोंदवलेले).

**३. एक पूर्ण वेगळी दिशा try केली आणि सोडून दिली — "बाप्पा स्वतः बोलतोय" (first-person, बालसुलभ):** `audio-drafts/part-01.txt` मध्ये एक संपूर्ण वेगळा स्क्रिप्ट-प्रयोग सापडला — बाप्पा स्वतः लहान मुलांशी थेट बोलतोय अशा शैलीत ("नमस्कार माझ्या गोड बालमित्रांनो... मी तुमचा लाडका छोटा बाप्पा! ... माझ्या चिमुकल्या हातांमध्ये मी एवढी सगळी शस्त्रं आणि खेळणी का घेऊन बसलोय? ती 'जादूची खेळणी' आहेत!"). या स्क्रिप्टच्या **३ आवृत्त्या** (मूळ, v2, v3) सापडल्या — प्रत्येक आवृत्तीत विराम/उत्स्फूर्त वाक्यरचना ("अरे हो, तुम्हाला माहित्ये का...") वाढवत नेलेली, TTS delivery जास्त नैसर्गिक/संवादी व्हावी म्हणून.

ही शैली शिप झालेल्या (verbatim-पुराण-मजकूर, तृतीय-पुरुषी) framing पेक्षा पूर्णपणे वेगळी होती — **आणि ती शिप झाली नाही** (`app.js`/`data.json` मध्ये तपासलं, कुठलाही संदर्भ नाही).

**४. या दिशेसाठी लहान-मुलांचा आवाज (child voice) इंजिनिअर करण्याचा गंभीर प्रयत्न झाला — दोन वेगळ्या तांत्रिक पद्धतींनी:**
   - **पद्धत अ (सोपी):** `_tts_part.py` — librosa चा साधा pitch-shift (३-५ semitones = नैसर्गिक बाल-स्वर, >6 वर "chipmunky"/कृत्रिम वाटू लागतं — स्वतः स्क्रिप्टमध्ये नोंदवलेलं निरीक्षण)
   - **पद्धत ब (सखोल):** `_baby_voice.py` — WORLD vocoder (pyworld) वापरून आवाज पिच (F0), स्पेक्ट्रल envelope (vocal-tract आकार) आणि aperiodicity असा वेगळा केला, मग वेगवेगळ्या प्रमाणात बदलला — **कारण:** साधा pitch-shift पिच आणि formants एकाच प्रमाणात हलवतो, त्यामुळे ६ semitones नंतर आवाज "चिपमंक" सारखा होतो; खरा फरक (लहान मूल vs वेगवान प्रौढ) formants वेगळ्या, कमी प्रमाणात बदलण्यातून येतो. Breathiness आणि "warmth" (low-shelf boost) सुद्धा वेगळे जोडले — कारण पिच वाढवल्यावर आवाज "पातळ" वाटतो.
   - **प्रत्यक्ष मोजमाप वापरलं, अंदाज नाही:** Sarvam च्या मूळ आवाजाचा pitch-contour सपाट असल्याचं मोजलं (~76Hz p10-p90 spread), खऱ्या मुलांच्या comedy-आवाजाशी (~190-330Hz spread) तुलना करून "expand" पॅरामीटर जोडला — जेणेकरून वाचन सपाट न वाटता उत्स्फूर्त वाटेल
   - **अनेक फेऱ्या केल्या:** baby-B1 ते B6 (६ आवृत्त्या), kid-C1-3, kid-D1-2 — म्हणजे पॅरामीटर्स वारंवार ट्यून केले
   - **निकाल: शिप केलं नाही** — अंतिम साइटवर सर्व आवाज प्रौढ "ritu" आवाजातच आहेत (पुष्टी: `app.js`/`data.json` मध्ये baby/kid फाइल्सचा संदर्भ सापडला नाही)

**५. एक अनिश्चित नोंद:** `audio-scripts/multi-speaker_एकदंत.wav` (६.२ MB, २२ Aug) — नावावरून "बहु-आवाज" प्रयोग एकदंत (आयटम ००१) साठी वाटतो, पण सोबत कुठलाही script/text फाइल सापडली नाही — **नेमका उद्देश अपडताळित**, अंदाजाने सांगत नाही.

**हे केस-स्टडीत का महत्त्वाचं:** "एकच आवाज generate करून वापरला" ही साधी गोष्ट नाही — किमान ३ आवाज, ३ टोन-आवृत्त्या, १ पूर्ण वेगळी narrative-दिशा, आणि २ स्वतंत्र तांत्रिक पद्धतींनी child-voice इंजिनिअरिंग — हे सगळं try करून, मोजून, **मुद्दाम सोडून दिलं** आणि साधी, विश्वासार्ह प्रौढ-आवाज + verbatim-मजकूर दिशा निवडली. हे निर्णय-प्रक्रियेचा खरा खोलवरचा पुरावा आहे.

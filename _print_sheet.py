"""Lay all 24 QR cards out on A4 pages at their true 300-DPI print size,
...
def main():
    ...
    # home card) made every slot too short, so 22 of 24 taller cards spilled
    ...
    out_pdf = ROOT / "qr-codes" / "print-sheet-A4.pdf"
